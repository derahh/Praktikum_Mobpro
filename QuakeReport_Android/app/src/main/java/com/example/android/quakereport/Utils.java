...
//
//        ArrayList<Earthquake> gempa = new ArrayList<>();
//
//        try {
...
//
//                Earthquake data = new Earthquake(magnitude, location, time, url);
//
//                gempa.add(data);
//            }
//
...
//    }
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl){
        ...
        try {
            ...
            Log.e("TAG", "fetchEarthquakeData: " + e.getMessage());
        }

        ArrayList<Earthquake> earthquakes = (ArrayList<Earthquake>) extraFeatureFromJson(jsonResponse);

        return earthquakes;
    }

    public static ArrayList<Earthquake> extraFeatureFromJson(String earthquakeJSON){
        ...
        try {
            ...
            Log.e("TAG", "extraFeatureFromJson: " + e.getMessage());
        }
        return earthquakes;
    }
