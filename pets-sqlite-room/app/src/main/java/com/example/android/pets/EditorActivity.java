...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentPet == null) {
            ...
            petChoosen = mPetViewModel.getPetById(idPet);
        }
    ...
    private void savePet() {
        ...
        if (currentPet == null) {
            ...
            mPetViewModel.insert(new PetEntity(nameString, breedString, mGender, weightInt));
        } else {
...
//            mPetViewModel.update(petChoosen);
        }
    }
    ...
    private void deletePet() {
        ...
        mPetViewModel.delete(currentPet);
